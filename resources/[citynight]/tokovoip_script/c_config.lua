TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannelWait = "Arrive en ville",

		-- Blocking screen informations
		TSServer = "176.31.122.189:4010", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "Support sur discord", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "https://discord.gg/SzCcTeE", -- Download link displayed on blocking screen
