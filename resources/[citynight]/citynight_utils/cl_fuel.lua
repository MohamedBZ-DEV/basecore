...
Citizen.CreateThread(function()
	...
	while true do
		...
		-- 		essence = GetVehicleFuelLevel( GetVehiclePedIsIn(GetPlayerPed(-1), false))/65
		-- 		print(essence)
		-- 		print(essence)
		-- 		print(essence)
...
function isNearStation()
	...
	for _,items in pairs(station) do
		if(GetDistanceBetweenCoords(items.x, items.y, items.z, plyCoords["x"], plyCoords["y"], plyCoords["z"], true) < 3.5) then
			return true, items.s
		end
	end
