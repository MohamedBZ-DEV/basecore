...
function Player.CreatePlayer(_source)
    ...
    FLT.AddItem = function(item,amount,data,label,id)
        print(item,amount,data,label,id)
        if id == nil then
...
AddEventHandler('playerDropped', function (reason) Player.Disconnected(source) end)
RegisterServerEvent("core:SetNumber")
AddEventHandler("core:SetNumber", function(price)
...
AddEventHandler("core:GetMoney", function(callback,_source)
...
AddEventHandler("money:Pay22", function(price,s)
    local player = Player.GetPlayer(s)
    player.addMoney(price)
end)
RegisterServerEvent("black_money:Pay22")
AddEventHandler("black_money:Pay22", function(price,s)
    local player = Player.GetPlayer(s)
...
AddEventHandler("money:Add2", function(price,xxxx)
    local player = Player.GetPlayer(xxxx)
    player.addMoney(price)
end)

RegisterServerEvent("black_money:Add2")
AddEventHandler("black_money:Add2", function(price,xxxx)
...
AddEventHandler("black_money:Pay2", function(price,xxxx)
    local player = Player.GetPlayer(xxxx)
    player.removeBlackMoney(price)
end)
RegisterServerEvent("money:Remove2")
AddEventHandler("money:Remove2", function(price,xxxx)
    local player = Player.GetPlayer(xxxx)
    player.removeMoney(price)
end)
...
RegisterServerEvent("core:ImDead")
AddEventHandler("core:ImDead",function(bool)
    PlayerDead[GetIdentifiers(source).steam] = bool
end)


RegisterServerCallback("core:GetDead",function(source,cb)
    cb(PlayerDead[GetIdentifiers(source).steam])
end)