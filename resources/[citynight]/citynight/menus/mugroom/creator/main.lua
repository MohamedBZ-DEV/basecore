...
function GiveClothes()
    ...
    local data = {torso=torso1,pant=legs1,chaus=feet1,unders=undershit1,access=-1,tops=tops1,pantcolor=legs2,chausscolor=feet2,underscolor=undershit2,topcolor=tops2,accesscolor=-1}
    local item = {}
    item.name = "tenue"
    item.data = data
