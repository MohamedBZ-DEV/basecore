...
local globalWeaponTable =  {
	blanc = {
        { 'WEAPON_KNUCKLE', 'Poing Americain',200},
        { 'WEAPON_SWITCHBLADE', "Cran d'arrêt",450},
        { 'WEAPON_KNIFE', 'Couteau' ,300},
        { 'WEAPON_HAMMER', 'Marteau',500},
        { 'WEAPON_BAT', 'Bat',250},
        { 'WEAPON_GOLFCLUB', 'Club Golf',250},
        { 'WEAPON_CROWBAR', 'Pied de biche',350},
        { 'WEAPON_POOLCUE', 'Queue de billard',300},
        { 'WEAPON_WRENCH', 'Clé anglaise' ,400},
        { 'WEAPON_FLASHLIGHT', 'Lampe torche',50},
        { 'WEAPON_BOTTLE', 'Bouteille Cassé',250},
    },
    pistol = 
    {
        { 'WEAPON_PISTOL', 'Pistolet',3000},
        { 'WEAPON_COMBATPISTOL', 'Pistolet de combat',5000},
        { 'WEAPON_PISTOL50', 'Pistolet Calibre.50',10000},
        { 'WEAPON_SNSPISTOL', 'SNS Pistol',2000},
       }
}
