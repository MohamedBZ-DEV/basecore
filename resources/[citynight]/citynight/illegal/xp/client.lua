...
levelsRange = 10000
function GetPlyLevel()
    CurLevel = XNL_GetLevelFromXP(XNL_CurrentPlayerXP)
    return CurLevel
end
function GetPlyTotalXp()
    return XNL_CurrentPlayerXP
end


function GetXpRequiredNextLvl()
    return math.floor(math.floor(XNL_CurrentPlayerXP/levelsRange) + 1 * ((levelsRange*GetPlyLevel())+1478*GetPlyLevel()))
end
...
RockstarRanks = {}
    Citizen.CreateThread(function()
        ...
        for i =1,500,1 do
            RockstarRanks[i] = (levelsRange*i)+1478*i
        end
    end)
    ...
    function XNL_AddPlayerXP(XPAmount)
        ...
        if not is_int(XPAmount) then
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_AddPlayerXP'")
            --("XNL WARNING: The script which is calling this function is not passing an integer!")
            --("=====================================================================================================")
            return
        end
        ...
        if XPAmount < 0 then
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_AddPlayerXP'")
            --("XNL WARNING: is trying to TAKE XP from a player, use 'XNL_RemovePlayerXP' instead!")
            --("=====================================================================================================")
            return
        end
    ...
    function XNL_RemovePlayerXP(XPAmount)
        ...
        if not is_int(XPAmount) then
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_RemovePlayerXP'")
            --("XNL WARNING: The script which is calling this function is not passing an integer!")
            --("=====================================================================================================")
            return
        end
        ...
        if XPAmount < 0 then
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_RemovePlayerXP'")
            --("XNL WARNING: is trying to give 'negative' XP by passing a negative value, If you for example  ")
            --("XNL WARNING: want to remove 100XP just use: 'XNL_RemovePlayerXP(100)' to remove 100XP from the player")
            --("=====================================================================================================")
            return
        end
    ...
    function XNL_GetXPFloorForLevel(intLevelNr)
        if is_int(intLevelNr) then
            ...
            if intLevelNr > 7999 then
                intLevelNr = 7999
                --("=====================================================================================================")
                --("XNL WARNING: You have an error in one of your scripts which is trying to get the floor level XP for")
                --("XNL WARNING: an player level beyond level 7999, which is the game limit!")
                --("XNL WARNING: Script has prevented this and set the 'limit' to 7999!")
                --("=====================================================================================================")
            end
            ...
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_GetXPFloorForLevel'")
            --("XNL WARNING: The script which is calling this function is not passing an integer!")
            --("=====================================================================================================")
    ...
    function XNL_GetXPCeilingForLevel(intLevelNr)
        if is_int(intLevelNr) then
            ...
            if intLevelNr > 7999 then
                intLevelNr = 7999
                --("=====================================================================================================")
                --("XNL WARNING: You have an error in one of your scripts which is trying to get the ceiling level XP")
                --("XNL WARNING: for an player level beyond level 7999, which is the game limit!")
                --("XNL WARNING: Script has prevented this and set the 'limit' to 7999!")
                --("=====================================================================================================")
            end
            ...
            if intLevelNr < 1 then
                --("=====================================================================================================")
                --("XNL WARNING: You have an error in one of your scripts which is trying to get the ceiling level XP")
                --("XNL WARNING: for an player level BELLOW level 1, which is the game limit!")
                --("XNL WARNING: Script has prevented this and set the 'limit' back to 1!")
                --("=====================================================================================================")
            ...
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_GetXPCeilingForLevel'")
            --("XNL WARNING: The script which is calling this function is not passing an integer!")
            --("=====================================================================================================")
            return 0 -- YES this MIGHT cause an XP bar which will not show xp drawing for a moment IF there is an error in the script, but it will prevent crashing!
        end
    ...
    function XNL_GetLevelFromXP(intXPAmount)
        ...
        if is_int(intXPAmount) then
            ...
            --("=====================================================================================================")
            --("XNL WARNING: You have an error in one of your scripts calling the function 'XNL_GetLevelFromXP'")
            --("XNL WARNING: The script which is calling this function is not passing an integer!")
            --("=====================================================================================================")
